...
class AIAssistantService {
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'messages': [
            ...history.take(history.isNotEmpty ? history.length - 1 : 0),
            {
              'role': 'user',
              'content': _buildGroqPrompt(prompt, stocks, pharmacies),
            },
          ],
          'temperature': 0.3,
        }),
  ...
  String _buildGroqPrompt(
    ...
    buffer.writeln('Use normal English prose only. Do not use Markdown, headings, bullet points, numbered lists, bold text, or special formatting.');
